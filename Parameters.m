...
function PARAMS = TASK_PARAMETERS()
% -- scene 1: fixation params -- %
PARAMS.fix_radius = 3; % fixation window (in degrees):
PARAMS.hold_radius = fix_radius; % radius that patient needs to hold fixation after entering fix radius
...
PARAMS.reward_box_edge_color = [1 0 0];
PARAMS.reward_box_face_color = [1 0 0];
